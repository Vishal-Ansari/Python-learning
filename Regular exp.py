...
bahut hi badia aadmi haiaiinaiiiiiiiiiiii'''
 ...
 # functions of the regular exporession are the 
 # findall, search, finiter, split, sub..\


# find=re.compile(r'vishal')
# matches=find.finditer(mystr)
# for match in matches:
#     print(match)
#     # print(mystr[0:6],mystr[198:204])
